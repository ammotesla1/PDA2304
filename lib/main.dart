import 'package:firebase_test/dataPage.dart';
                          ...
                          onPressed: () async {
                            if(capcha.text.isEmpty){
                              try {
                                ...
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const TestStatePage()));                                
                              } catch (e) {
                              if(e.toString().contains('user-not-found')) {
                                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Пользователь с такой почтой не найден')));
                      ...
                      child: Material(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            .add({"email": login.text, "password": password.text});
