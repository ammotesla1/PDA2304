...
class CarEntity{
  ...
  CarEntity({required this.car_description, required this.car_cost, required this.car_year, required this.car_mark_id, required this.car_engine_id, required this.car_color_id, required this.car_KPPtype_id, required this.car_photo_id});
}
